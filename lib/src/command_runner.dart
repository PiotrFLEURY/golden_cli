...
const packageName = 'golden_cli';
const description =
    'A Dart CLI made to help with Golden comparisons in Flutter';

/// {@template golden_cli_command_runner}
...
/// ```
/// {@endtemplate}
class GoldenCliCommandRunner extends CompletionCommandRunner<int> {
  /// {@macro golden_cli_command_runner}
